...
public class Board {
        ...
        for(int i = 0; i < SnakeLadder.height; i++){
            ...
            for(int j = 0; j < SnakeLadder.width; j++){
                if(y % 2 == 0){
                    ...
                    xPos = (SnakeLadder.tileSize*SnakeLadder.width) - (x*SnakeLadder.tileSize -SnakeLadder.tileSize/2);
                }
    ...
    int getXCCoordinate(int position){
        return positionCoordinates.get(position).getKey();
    }
    int getYCCoordinate(int position){
